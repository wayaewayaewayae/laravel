...
<html lang="en">
   <head>
      ...
      <!-- bootstrap css -->
      <link rel="stylesheet" href="frondend/css/bootstrap.min.css">
      <!-- style css -->
      <link rel="stylesheet" href="frondend/css/style.css">
      <!-- Responsive-->
      <link rel="stylesheet" href="frondend/css/responsive.css">
      <!-- fevicon -->
      <link rel="icon" href="frondend/images/fevicon.png" type="image/gif" />
   ...
   <body class="main-layout">
      <!-- loader  -->
      <div class="loader_bg">
         <div class="loader"><img src="frondend/images/loading.gif" alt="#"/></div>
      </div>
      <!-- end loader -->
      <!-- top -->
                    <!-- header -->
                     ...
                     <div class="navbar-area">
                        <nav class="site-navbar">
                           <ul>
                              ...
                              <li><a href="index.blade.php" class="logo_midle">covido</a></li>
            ...
            <div class="row d_flex">
               ...
               <div class="col-md-5">
                  <div class="about_img text_align_center">
                     <figure><img src="frondend/images/about.png" alt="#"/></figure>
                  </div>
               </div>
            ...
            <div class="row d_flex grid">
               <div class="col-md-7">
                  <div class="coronata_img text_align_center">
                     <figure><img src="frondend/images/corona.png" alt="#"/></figure>
                  </div>
               </div>
                  ...
                  <div class="owl-carousel owl-theme">
                     <div class="item">
                        <div class="protect_box text_align_center">
                          <div class="desktop">
                             <i><img src="frondend/images/pro1.png" alt="#"/></i>
                           <h3> Wear Mask</h3>
                     ...
                     <div class="item">
                          <div class="protect_box text_align_center">
                          <div class="desktop">
                             <i><img src="frondend/images/pro2.png" alt="#"/></i>
                     ...
                     <div class="item">
                         <div class="protect_box text_align_center">
                          <div class="desktop">
                             <i><img src="frondend/images/pro3.png" alt="#"/></i>
                           <h3> Stay at Home</h3>
                           <span> Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for</span>
                          </div>
                           <a class="read_more" href="protect.html">Read More</a>
            ...
            <div class="row d_flex">
               <div class=" col-md-4">
                  <div class="latest text_align_center">
                     <figure><img src="frondend/images/cases1.png" alt="#"/></figure>
               ...
               <div class=" col-md-4">
                  <div class="latest text_align_center">
                     <figure><img src="frondend/images/cases2.png" alt="#"/></figure>
                      <a class="read_more" href="cases.html">Read More</a>
                     <div class="nostrud">
                        <h3>Cases 02</h3>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
               ...
               <div class=" col-md-4">
                  <div class="latest text_align_center">
                     <figure><img src="frondend/images/cases3.png" alt="#"/></figure>
                      <a class="read_more" href="cases.html">Read More</a>
                     <div class="nostrud">
                        <h3>Cases 03</h3>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
            ...
            <div class="row d_flex">
               <div class=" col-md-6">
                     <div id="ho_efcet" class="reader text_align_center">
                        <i><img src="frondend/images/doctor1.png" alt="#"/></i>
                        <h3>Dr.Golap den</h3>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
                        <span><img src="frondend/images/do.png" alt="#"/></span>
                     </div>
                  </div>
                          <div class=" col-md-6">
                     <div id="ho_efcet" class="reader text_align_center">
                        <i><img src="frondend/images/doctor2.png" alt="#"/></i>
                        <h3>Dr.Golap den</h3>
                        <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look</p>
                        <span><img src="frondend/images/do.png" alt="#"/></span>
                     </div>
...
<!-- update -->
               ...
               <div class="row">
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6">
                           <div class="hedingh3 text_align_left">
                              <h3>countrys</h3>
                              <div class="map">
                                <img src="frondend/images/map.png" alt="#"/>
                              </div>
                           </div>
                        </div>
      ...
      <script src="frondend/https://cdnjs.cloudflare.com/ajax/libs/baguettebox.js/1.8.1/baguetteBox.min.js"></script>
      <script src="frondend/js/owl.carousel.min.js"></script>
      <script src="frondend/js/custom.js"></script>
   </body>
</html>