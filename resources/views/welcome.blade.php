...
<body id="page-top">
    ...
    <header class="masthead bg-info text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <img src="assets/img/portfolio/virus.jpg" alt="" />
            <!-- Masthead Heading-->
            <br>
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">Coronavirus Global & Indonesia Live Data
            </p>
        </div>
    </header>
    <!-- Portfolio Section-->
    <section class="page-section portfolio" id="portfolio">
        <div class="container">
            ...
            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Data Virus Corona
            </h2>
            <!-- Icon Divider-->
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h4 class="card-title text-uppercase text-muted mb-0">Total Meninggal</h4>
                                    <h5>
                                        <p><?php echo $meninggal['value']; ?></p>
                                    </h5>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mr-auto">
                    <p class="lead">You can create your own custom avatar for the
                        masthead, change the icon in the
                        dividers, and add your email address to the contact form to
                        make
                        it fully functional!</p>
                </div>
            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <p class="mb-5">Lorem ipsum dolor sit amet,
                                    ...
                                    recusandae
                                    quos quis inventore quisquam
                                    velit asperiores, vitae? Reprehenderit soluta,
                                    eos
